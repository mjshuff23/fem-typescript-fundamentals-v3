...
const phonesSignature: {
  [key: string]: {
    country: string;
    area: string;
    number: string;
  }
} = {}; // This is an empty object with an index signature
...
const fileExtensions2: string[] = ["js", "ts"];  // explicitly way 1
const fileExtensions3: Array<string> = ["js", "ts"];  // explicitly way 2
...
let mySecondCar: [number, string, string] = [2021, "Mitsubishi", "Outlander SE"];
