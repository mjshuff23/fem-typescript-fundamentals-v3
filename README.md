...
- [Lesson 0: Index](./src/00-index.ts)
- [Lesson 1: Intro](./src/01-intro.ts)
- [Lesson 2: Objects, Arrays, and Tuples](./src/02-objects_arrays_tuples.ts)
- [Lesson 3: Unions and Intersections](./src/03-unions_intersections.ts)
- [Lesson 4: Interfaces and Types](./src/04-interfaces_types.ts)
- [Lesson 5: JSON Exercise](./src/05-json_exercise.ts)
